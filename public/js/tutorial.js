...
const STEPS = [
  ...
  {
    text: IS_TOUCH
      ? '<b>Постройки</b> ставятся на своей половине карты: шахты и банки ускоряют доход, башни защищают проходы, баррикады перегораживают путь. Выберите постройку, тапните по земле и нажмите <b>«✓ Построить»</b>.'
      : '<b>Постройки</b> ставятся на своей половине карты: шахты и банки ускоряют доход, башни защищают проходы, баррикады перегораживают путь. Выберите постройку и кликните по земле.',
    anchor: '#build-panel',
  },
  {
