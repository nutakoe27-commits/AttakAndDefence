...
const STEPS = [
  ...
  {
    text: IS_TOUCH
      ? '<b>Постройки</b> ставятся <b>на горах</b> своей половины (валидные клетки подсвечиваются): шахты и банки — доход, башни простреливают коридор. Лучшие места — <b>изгибы коридора</b>: оттуда башня достаёт до большего куска пути. Выберите постройку, тапните по горе и нажмите <b>«✓ Построить»</b>.'
      : '<b>Постройки</b> ставятся <b>на горах</b> своей половины (валидные клетки подсвечиваются): шахты и банки — доход, башни простреливают коридор. Лучшие места — <b>изгибы коридора</b>: оттуда башня достаёт до большего куска пути. Выберите постройку и кликните по горе.',
    anchor: '#build-panel',
  },
  {
